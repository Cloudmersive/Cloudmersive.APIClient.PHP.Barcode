...
```
{
  "repositories": [
    {
      "type": "git",
      "url": "https://github.com/cloudmersive/barcode_api_client.git"
    }
  ],
  "require": {
    "cloudmersive/barcode_api_client": "*@dev"
  }
}
```
...
```php
    require_once('/path/to/barcode_api_client/vendor/autoload.php');
```
